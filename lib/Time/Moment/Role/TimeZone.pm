...
Note that `with_time_zone_offset_same_local` may throw an exception here if the
new local time does not exist in that time zone (e.g. between 2 and 3 AM on the
